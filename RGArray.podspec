#
#  Be sure to run `pod spec lint RGArray.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/RengeRenge/RGArray.git"
  ...
  s.source       = { :git => "https://github.com/RengeRenge/RGArray.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "RGArray/RGArray/*.{h,m}"
